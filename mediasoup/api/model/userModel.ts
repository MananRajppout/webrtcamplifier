class UserModel {
    ...
    constructor(socketId:string,isModirator:boolean,username:string,room_id:string,isWebCamMute:boolean=true,isMicMute:boolean=true,isShareScreen:boolean=false){
