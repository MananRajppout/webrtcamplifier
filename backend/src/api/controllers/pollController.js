...
const getAllPolls = async (req, res) => {
  try {
    ...
    const polls = await Poll.find({ projectId: req.params.projectId, status: true }).populate("createdById", "firstName lastName email").populate("projectId", "name description");
