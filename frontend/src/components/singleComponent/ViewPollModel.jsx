...
const ViewPollModel = ({onClose, polls,onPageChange,pollPage,totalPollPages}) => {
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-30">
            <div className="bg-white p-2 rounded-2xl w-[800px]">
                <div className="flex items-center justify-between px-4">
                    <h2 className="text-2xl font-semibold mb-1 text-custom-dark-blue-2">View Polls</h2>
                            ...
                            <tbody>
                                {polls?.map((poll) => (
                                    <tr key={poll._id}>
                                        ...
                                        <TableData>
                                            <Button className="!text-blue-500" variant="plain">enable</Button>
                                        </TableData>
                                    </tr>
                                ))}

                                {
                                    polls?.length == 0 && (
                                        <tr>
                                            <td colSpan={6} className="text-center py-4">No Active Polls Found</td>
                                        </tr>
                                    )
                                }
                            </tbody>
